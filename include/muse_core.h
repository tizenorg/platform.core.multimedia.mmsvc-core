...
int muse_core_client_set_flash_state(muse_module_h module, int set_flash_state);
int muse_core_client_get_flash_state(muse_module_h module, int *get_flash_state);
