...
typedef struct muse_core_module {
	...
	void (*set_module_state) (muse_module_h, muse_module_state_e);
	int (*get_module_state) (muse_module_h);
	void (*set_flash_state) (muse_module_h, muse_module_cam_flash_state_e);
	int (*get_flash_state) (muse_module_h);
	void (*set_shutter_sound_policy) (muse_module_h, muse_module_cam_shutter_sound_policy_e);
	int (*get_shutter_sound_policy) (muse_module_h);
