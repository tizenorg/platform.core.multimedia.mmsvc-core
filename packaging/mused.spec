...
%ifarch %arm aarch64
export CFLAGS+=" -DTIZEN_BUFFER_MANAGER_MUSE_ENABLE"
export CXXFLAGS="$CXXFLAGS -DTIZEN_BUFFER_MANAGER_MUSE_ENABLE"
export FFLAGS="$FFLAGS -DTIZEN_BUFFER_MANAGER_MUSE_ENABLE"
%endif
