...
int muse_core_client_set_state(muse_module_h module, int set_module_state)
{
	g_return_val_if_fail(module->api_module >= MUSE_PLAYER && module->api_module <= MUSE_RECORDER, MM_ERROR_INVALID_ARGUMENT);
	muse_core_module_get_instance()->set_module_state(module->api_module, set_module_state);
	return MM_ERROR_NONE;
}

int muse_core_client_get_state(muse_module_h module, int *get_module_state)
{
	g_return_val_if_fail(module->api_module >= MUSE_PLAYER && module->api_module <= MUSE_RECORDER, MM_ERROR_INVALID_ARGUMENT);
	g_return_val_if_fail(get_module_state, MM_ERROR_INVALID_ARGUMENT);
	*get_module_state = muse_core_module_get_instance()->get_module_state(module->api_module);
	return MM_ERROR_NONE;
}

int muse_core_cam_client_set_flash_state(muse_module_h module, int set_flash_state)
{
	g_return_val_if_fail(module->api_module == MUSE_CAMERA || module->api_module == MUSE_RECORDER, MM_ERROR_INVALID_ARGUMENT);
	muse_core_module_get_instance()->set_flash_state(module->api_module, set_flash_state);
	return MM_ERROR_NONE;
}

int muse_core_cam_client_get_flash_state(muse_module_h module, int *get_flash_state)
{
	g_return_val_if_fail(module->api_module == MUSE_CAMERA || module->api_module == MUSE_RECORDER, MM_ERROR_INVALID_ARGUMENT);
	g_return_val_if_fail(get_flash_state, MM_ERROR_INVALID_ARGUMENT);
	*get_flash_state = muse_core_module_get_instance()->get_flash_state(module->api_module);
	return MM_ERROR_NONE;
}
