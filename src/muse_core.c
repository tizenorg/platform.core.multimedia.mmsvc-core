...
{
	muse_core_module_get_instance()->set_module_state(client, module_state);
}

int muse_core_client_get_state(int client)
{
	return muse_core_module_get_instance()->get_module_state(client);
}

void muse_core_cam_client_set_flash_state(int flash_state)
{
	muse_core_module_get_instance()->set_flash_state(flash_state);
}

int muse_core_cam_client_get_flash_state(void)
{
	return muse_core_module_get_instance()->get_flash_state();
}
